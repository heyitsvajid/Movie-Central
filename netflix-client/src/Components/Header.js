          ...
          <div class="main-header has-billboard" style={{height:'66px'}}>
              ...
              <div class="secondary-navigation">
                  <div class="nav-element">
                      <div class="searchBox">
                      <div class="searchBox">
                      <div class="searchInput" style={{backgroundColor: 'black'}}>
                  ...
                  <div class="nav-element show-kids"><a style={{color: 'red'}} href="" onClick={ this.handleLogout.bind(this) }>Logout</a></div>
              </div>
          </div>
      </div>
    </div>
